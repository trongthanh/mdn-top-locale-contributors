	...
	<Layout>
		...
		<article class="container">
			...
			<p>
				...
				piece. So, ranking top contributors based on number of articles written / translated is the best measure
				for now. If two or more authors has the same number of articles contributed, they are then sorted by
				latest entry made.
			</p>
			<p>
				Bear in mind that the rank is <strong>not real time</strong>. The list of changes will be scraped again
				at intervals and accumulated offsets. This post will be updated when the scraping mechanism is more
				mature and stable.
			</p>
			<h2>Who are you?</h2>
			<p>
				I am just another JavaScript developer from{' '}
